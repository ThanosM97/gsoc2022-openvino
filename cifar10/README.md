...
the [create_dataset.py](cifar10/create_dataset.py) script, and it can be found [here](https://drive.google.com/file/d/1Akx9qLfbA-0cq9vbXC6FerYCADs-YeJj/view?usp=sharing).
...
2. Install the python packages in the [requirements](cifar10/requirements.txt) file.
